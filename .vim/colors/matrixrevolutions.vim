...
let g:colors_name = 'matrixrevolutions'
" well this is a comment yo!
hi Boolean        guifg=#e6fff3 guibg=#43705a gui=none
hi Character      guifg=#e6fff3 guibg=#000000 gui=none
hi Comment        guifg=#aaaaaa guibg=#000000 gui=none
hi Conditional    guifg=#e6fff3 guibg=#000000 gui=bold
hi Constant       guifg=#e6fff3 guibg=#000000 gui=none
...
hi IncSearch      guifg=#113322 guibg=#61a181 gui=bold
hi Search         guifg=#113322 guibg=#61a181 gui=bold
...
hi LineNr         guifg=#9bcfb5 guibg=#222222 gui=bold
...
hi NonText        guifg=#9bcfb5 guibg=#000000 gui=bold
...
hi Underlined     guifg=#e6fff3 guibg=#000000 gui=none
